...
# -*- coding: utf-8 -*-
"""
Created on Mon May  7 16:03:20 2018
...
A player starts on the GO square and adds the scores on two 6-sided dice to determine
 ...
 Without any further rules we would expect to visit each square with equal probability: 
...
directly to jail, if a player rolls three consecutive doubles, 
...
the probability of finishing on it is zero, 
the CH squares will have the lowest probabilities, 
as 5/8 request a movement to another square, and it is the final square that 
the player finishes at on each roll that we are interested in. 
